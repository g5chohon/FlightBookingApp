...
public class Driver {
    ...
    public static void uploadClientInfo(String path) {
        try {
            FlightSystem.getInstance().loadClients(path);
    ...
    public static void uploadFlightInfo(String path) {
        try {
            FlightSystem.getInstance().loadFlights(path);
        } catch (FileNotFoundException e) {
    ...
    public static String getClient(String email) {
        ...
        Client client = fs.searchClient(email);
    ...
    public static String getFlights(String date, String origin, String destination) {
        FlightSystem fs = FlightSystem.getInstance();
        fs.searchFlight(origin, destination, date);

        return fs.displaySearchedFlights();
    }
    ...
    public static String getItineraries(String date, String origin, String destination) {
        FlightSystem fs = FlightSystem.getInstance();
        try {
            fs.searchForItineraries(origin, destination, date);
        } catch (ParseException e) {

        }
        return fs.displayItineraries();
    }
